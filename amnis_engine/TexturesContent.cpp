...
TexturesContent::TexturesContent(Graphics* graphics)
{
	...
	stoneWallNormalMap = new Texture(graphics, L"Textures\\Wall_Stone_017_Normal.jpg");
	stoneWallAlbedo = new Texture(graphics, L"Textures\\Wall_Stone_017_BaseColor.jpg");
